...
//        super(key: key);
  ...
  const PhotoViewImageWrapperTopLeft.customChildNew({
    Key key,
  ...
  State<StatefulWidget> createState() {
    return _PhotoViewImageWrapperTopLeftState();
  }
}

class _PhotoViewImageWrapperTopLeftState extends State<PhotoViewImageWrapperTopLeft>
  ...
  @override
  void didUpdateWidget(PhotoViewImageWrapperTopLeft oldWidget) {
